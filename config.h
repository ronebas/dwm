...
static const int user_bh            = 23;        /* user bar height */
...
/* commands */
static const char *dmenucmd[] = { "dmenu_run", "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_sel, "-sf", col_gray4, NULL };
